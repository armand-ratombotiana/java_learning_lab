...
public class TerraformConfigBuilder {
    ...
    public TerraformConfigBuilder set(String key, Object value) {
        config.put(key, value);
        return this;
    }

    @SuppressWarnings("unchecked")
    public TerraformConfigBuilder setNested(String keyPath, Object value) {
    ...
    public static void main(String[] args) {
        TerraformConfigBuilder builder = new TerraformConfigBuilder()
            .set("version", "1.0.0")
            .set("enabled", true)
            .setNested("service.name", "TerraformService")
