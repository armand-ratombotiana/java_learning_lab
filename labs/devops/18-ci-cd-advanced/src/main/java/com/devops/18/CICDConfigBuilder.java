...
public class CICDConfigBuilder {
    ...
    public CICDConfigBuilder set(String key, Object value) {
        config.put(key, value);
        return this;
    }

    @SuppressWarnings("unchecked")
    public CICDConfigBuilder setNested(String keyPath, Object value) {
    ...
    public static void main(String[] args) {
        CICDConfigBuilder builder = new CICDConfigBuilder()
            .set("version", "1.0.0")
            .set("enabled", true)
            .setNested("service.name", "CICDService")
