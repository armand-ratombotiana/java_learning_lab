...
public class PackerConfigBuilder {
    private final Map<String, Object> config = new LinkedHashMap<>();

    public PackerConfigBuilder set(String key, Object value) {
        config.put(key, value);
        return this;
    }

    @SuppressWarnings("unchecked")
    public PackerConfigBuilder setNested(String keyPath, Object value) {
    ...
    public static void main(String[] args) {
        PackerConfigBuilder builder = new PackerConfigBuilder()
            .set("version", "1.0.0")
            .set("enabled", true)
            .setNested("service.name", "PackerService")
