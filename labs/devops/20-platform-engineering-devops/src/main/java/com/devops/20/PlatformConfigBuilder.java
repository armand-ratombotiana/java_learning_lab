...
public class PlatformConfigBuilder {
    ...
    public PlatformConfigBuilder set(String key, Object value) {
        config.put(key, value);
        return this;
    }

    @SuppressWarnings("unchecked")
    public PlatformConfigBuilder setNested(String keyPath, Object value) {
    ...
    public static void main(String[] args) {
        PlatformConfigBuilder builder = new PlatformConfigBuilder()
            .set("version", "1.0.0")
            .set("enabled", true)
            .setNested("service.name", "PlatformService")
