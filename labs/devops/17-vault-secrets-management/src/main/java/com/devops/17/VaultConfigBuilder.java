...
public class VaultConfigBuilder {
    ...
    public VaultConfigBuilder set(String key, Object value) {
        config.put(key, value);
        return this;
    }

    @SuppressWarnings("unchecked")
    public VaultConfigBuilder setNested(String keyPath, Object value) {
    ...
    public static void main(String[] args) {
        VaultConfigBuilder builder = new VaultConfigBuilder()
            .set("version", "1.0.0")
            .set("enabled", true)
            .setNested("service.name", "VaultService")
