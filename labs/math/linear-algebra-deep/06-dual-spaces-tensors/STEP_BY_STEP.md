# Step-by-Step Guide: Dual Spaces and Tensors

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/dualtensors
mkdir -p src/test/java/com/mathlab/dualtensors
`
...
`java
@Test void testBasic() {
    assertEquals(expected, DualSpacesTensors.compute(input), 1e-10);
}
`
