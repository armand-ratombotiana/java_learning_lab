# References: Linear Transformations
...
## Academic Papers
1. Author (Year). Landmark paper on Linear Transformations. *Journal*.
...
## Citation Format
Author. "Linear Transformations." Math Academy, Java Learning Lab, 2026.
