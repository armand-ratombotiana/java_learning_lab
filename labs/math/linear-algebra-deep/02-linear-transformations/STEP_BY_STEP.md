# Step-by-Step Guide: Linear Transformations

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/lineartransforms
mkdir -p src/test/java/com/mathlab/lineartransforms
`
...
`java
@Test void testBasic() {
    assertEquals(expected, LinearTransformations.compute(input), 1e-10);
}
`
