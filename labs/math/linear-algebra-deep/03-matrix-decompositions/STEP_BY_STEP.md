# Step-by-Step Guide: Matrix Decompositions

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/matrixdecomp
mkdir -p src/test/java/com/mathlab/matrixdecomp
`
...
`java
@Test void testBasic() {
    assertEquals(expected, MatrixDecompositions.compute(input), 1e-10);
}
`
