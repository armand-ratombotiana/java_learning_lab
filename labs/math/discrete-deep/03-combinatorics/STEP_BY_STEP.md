# Step-by-Step Guide: Combinatorics

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/combinatorics
mkdir -p src/test/java/com/mathlab/combinatorics
`
...
`java
@Test void testBasic() {
    assertEquals(expected, Combinatorics.compute(input), 1e-10);
}
`
