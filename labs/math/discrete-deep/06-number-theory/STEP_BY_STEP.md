# Step-by-Step Guide: Number Theory

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/numbertheory
mkdir -p src/test/java/com/mathlab/numbertheory
`
...
`java
@Test void testBasic() {
    assertEquals(expected, NumberTheory.compute(input), 1e-10);
}
`
