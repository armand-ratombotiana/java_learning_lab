# Step-by-Step Guide: Generating Functions

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/generatingfunc
mkdir -p src/test/java/com/mathlab/generatingfunc
`
...
`java
@Test void testBasic() {
    assertEquals(expected, GeneratingFunctions.compute(input), 1e-10);
}
`
