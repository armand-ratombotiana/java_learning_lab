# Step-by-Step Guide: Graph Theory

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/graphtheory
mkdir -p src/test/java/com/mathlab/graphtheory
`
...
`java
@Test void testBasic() {
    assertEquals(expected, GraphTheory.compute(input), 1e-10);
}
`
