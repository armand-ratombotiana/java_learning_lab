...
`ash
mkdir -p src/main/java/com/mathlab/multivariatestats
mkdir -p src/test/java/com/mathlab/multivariatestats
`
...
`java
@Test void testBasic() {
    assertEquals(expected, MultivariateStatistics.compute(input), 1e-10);
}
`
