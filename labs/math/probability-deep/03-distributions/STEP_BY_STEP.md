...
`ash
mkdir -p src/main/java/com/mathlab/distributions
mkdir -p src/test/java/com/mathlab/distributions
`
...
`java
@Test void testBasic() {
    assertEquals(expected, ProbabilityDistributions.compute(input), 1e-10);
}
`
