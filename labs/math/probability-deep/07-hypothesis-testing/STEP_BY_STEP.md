...
`ash
mkdir -p src/main/java/com/mathlab/hypothesistesting
mkdir -p src/test/java/com/mathlab/hypothesistesting
`
...
`java
@Test void testBasic() {
    assertEquals(expected, HypothesisTesting.compute(input), 1e-10);
}
`
