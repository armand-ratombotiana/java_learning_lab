...
public record RealtimeanalyticsEngine(String engineId, String version, boolean active) {
    private static final Logger LOG = Logger.getLogger(RealtimeanalyticsEngine.class.getName());
