...
public record EcommerceEngine(String engineId, String version, boolean active) {
    private static final Logger LOG = Logger.getLogger(EcommerceEngine.class.getName());
