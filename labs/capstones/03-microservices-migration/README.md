# Capstone 03: Microservices Migration

## Overview
Monolith to microservices with strangler fig, CQRS, event sourcing

This lab provides comprehensive coverage of all major concepts, implementations,
and best practices for Microservices Migration. Through detailed theory, code deep dives,
...
## What You Will Learn
- Core concepts and architecture of Microservices Migration
