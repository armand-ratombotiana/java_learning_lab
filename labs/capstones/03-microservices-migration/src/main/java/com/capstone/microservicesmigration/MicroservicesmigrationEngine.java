...
public record MicroservicesmigrationEngine(String engineId, String version, boolean active) {
    private static final Logger LOG = Logger.getLogger(MicroservicesmigrationEngine.class.getName());
    ...
    public MicroservicesmigrationEngine {
