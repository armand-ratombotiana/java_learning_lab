...
## Question 1: Reverse Linked List (LC 206)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Reverse Linked List (LC 206). Please walk me through your approach and explain your thought process."
...
## Question 2: Linked List Cycle (LC 141)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Linked List Cycle (LC 141). This is a classic problem. I want to see how you approach it."
...
## Question 3: Merge Two Sorted Lists (LC 21)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Merge Two Sorted Lists (LC 21). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Linked Lists problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Linked Lists |
