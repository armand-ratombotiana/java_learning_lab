...
## Question 1: Range Sum Query Mutable (LC 307)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Range Sum Query Mutable (LC 307). Please walk me through your approach and explain your thought process."
...
## Question 2: Range Sum Query 2D Mutable (LC 308)

**Difficulty**: Hard
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Range Sum Query 2D Mutable (LC 308). This is a classic problem. I want to see how you approach it."
...
## Question 3: Count of Smaller Numbers After Self (LC 315)

**Difficulty**: Hard
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Count of Smaller Numbers After Self (LC 315). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Segment Trees problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Segment Trees |
