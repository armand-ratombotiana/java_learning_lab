...
## Question 1: Kth Largest Element in a Stream (LC 703)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Kth Largest Element in a Stream (LC 703). Please walk me through your approach and explain your thought process."
...
## Question 2: Find Median from Data Stream (LC 295)

**Difficulty**: Hard
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Find Median from Data Stream (LC 295). This is a classic problem. I want to see how you approach it."
...
## Question 3: Merge k Sorted Lists (LC 23)

**Difficulty**: Hard
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Merge k Sorted Lists (LC 23). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Heaps problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Heaps |
