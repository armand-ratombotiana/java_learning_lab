...
## Question 1: Number of Provinces (LC 547)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Number of Provinces (LC 547). Please walk me through your approach and explain your thought process."
...
## Question 2: Accounts Merge (LC 721)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Accounts Merge (LC 721). This is a classic problem. I want to see how you approach it."
...
## Question 3: Redundant Connection (LC 684)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Redundant Connection (LC 684). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Union-Find problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Union-Find |
