# Interview Questions: XOR and Unrolled Linked Lists

## Basic Questions

### Q1: Explain how XOR and Unrolled Linked Lists works.
Provide a high-level overview of the structure, its key operations, and their time complexities.

### Q2: What are the advantages of XOR and Unrolled Linked Lists over standard alternatives?
Discuss the specific performance characteristics, memory usage, and use cases where XOR and Unrolled Linked Lists excels.
...
### Q5: How would you make XOR and Unrolled Linked Lists thread-safe?
...
### Q7: Design a persistent version of XOR and Unrolled Linked Lists.
Discuss how to implement efficient snapshots and immutable operations.

### Q8: How would you benchmark XOR and Unrolled Linked Lists against alternatives?
Describe your benchmarking methodology, metrics, and analysis approach.

### Q9: Implement a custom hash function.
Write code for a hash function suitable for XOR and Unrolled Linked Lists and explain your design choices.
