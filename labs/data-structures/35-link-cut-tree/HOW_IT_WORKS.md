# How It Works: Link-Cut Tree

## Core Mechanism

The Link-Cut Tree operates on a fundamental principle that distinguishes it from simpler data structures. Understanding this core mechanism is the key to grasping all operations.
