# Internals: Link-Cut Tree

## Memory Layout

The internal representation of the Link-Cut Tree is carefully designed to balance performance and memory usage. Understanding the memory layout is crucial for writing efficient implementations.
