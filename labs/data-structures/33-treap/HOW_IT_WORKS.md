# How It Works: Treap (Randomized BST)

## Core Mechanism

The Treap (Randomized BST) operates on a fundamental principle that distinguishes it from simpler data structures. Understanding this core mechanism is the key to grasping all operations.
