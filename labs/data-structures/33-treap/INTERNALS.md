# Internals: Treap (Randomized BST)

## Memory Layout

The internal representation of the Treap (Randomized BST) is carefully designed to balance performance and memory usage. Understanding the memory layout is crucial for writing efficient implementations.
