...
## Question 1: Two Sum (LC 1)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Two Sum (LC 1). Please walk me through your approach and explain your thought process."
...
## Question 2: Best Time to Buy and Sell Stock (LC 121)

**Difficulty**: Easy
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Best Time to Buy and Sell Stock (LC 121). This is a classic problem. I want to see how you approach it."
...
## Question 3: Product of Array Except Self (LC 238)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Product of Array Except Self (LC 238). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Arrays problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Arrays |
