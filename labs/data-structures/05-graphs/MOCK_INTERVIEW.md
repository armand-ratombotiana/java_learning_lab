...
**Interviewer**: "Let us start with Number of Islands (LC 200). Please walk me through your approach and explain your thought process."
...
## Question 2: Clone Graph (LC 133)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Clone Graph (LC 133). This is a classic problem. I want to see how you approach it."
...
## Question 3: Course Schedule (LC 207)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: Course Schedule (LC 207). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Graphs problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Graphs |
