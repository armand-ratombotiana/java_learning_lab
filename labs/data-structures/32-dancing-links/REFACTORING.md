# Refactoring: Dancing Links (DLX)

## Improving the Design

Refactoring a data structure implementation follows specific patterns. This guide covers common refactoring opportunities for the Dancing Links (DLX).
