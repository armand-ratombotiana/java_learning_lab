...
## Question 1: Group Anagrams (LC 49)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Group Anagrams (LC 49). Please walk me through your approach and explain your thought process."
...
## Question 2: Top K Frequent Elements (LC 347)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Next question: Top K Frequent Elements (LC 347). This is a classic problem. I want to see how you approach it."
...
## Question 3: LRU Cache (LC 146)

**Difficulty**: Medium
**Time Allotted**: 15 minutes

**Interviewer**: "Final question: LRU Cache (LC 146). This one is more challenging, so take your time with the design."
...
|------|-------|---------------------|
| Core Pattern | Practice more Hash Tables problems | 5-10 additional problems on this topic |
...
| Company Specific | Target company patterns | LeetCode company tag for Hash Tables |
