# Architecture: EBS Customization and Extension

## 1. Component Overview

EBS Customization and Extension follows standard EBS patterns: presentation (Forms/OAF), business logic (PL/SQL + Java), and data layer.
