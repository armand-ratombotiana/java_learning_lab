# Architecture: EBS Technical Architecture

## 1. Component Overview

EBS Technical Architecture follows standard EBS patterns: presentation (Forms/OAF), business logic (PL/SQL + Java), and data layer.
