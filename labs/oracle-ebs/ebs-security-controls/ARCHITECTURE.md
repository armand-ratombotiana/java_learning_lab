# Architecture: EBS Security Controls

## 1. Component Overview

EBS Security Controls follows standard EBS patterns: presentation (Forms/OAF), business logic (PL/SQL + Java), and data layer.
