# Architecture: EBS Upgrade and Migration

## 1. Component Overview

EBS Upgrade and Migration follows standard EBS patterns: presentation (Forms/OAF), business logic (PL/SQL + Java), and data layer.
