...
## Security Overview
Security is critical when implementing cost optimization with reserved instances, savings plans, rightsizing, spot instances, and FinOps. This document covers best practices.
