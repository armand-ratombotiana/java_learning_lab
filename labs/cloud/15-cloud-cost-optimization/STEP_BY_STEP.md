...
`ash
mkdir -p src/main/java/com/cloud/clcost
mkdir -p src/test/java/com/cloud/clcost
...
function GetVisualGuide {
    param(Cloud Cost Optimization, cost optimization with reserved instances, savings plans, rightsizing, spot instances, and FinOps)
    return @"
## System Overview
...
**Cloud Cost Optimization** operates by orchestrating multiple components in a coordinated workflow.
