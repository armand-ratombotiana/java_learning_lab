# 10 - AWS Serverless - Exercises

## Overview
Practice implementing serverless computing with Lambda, Step Functions, EventBridge, and SAM through these hands-on exercises.

## Exercise 1: Basic Implementation
Create a Java program that demonstrates core AWS Serverless concepts.
...
Build a system that integrates multiple components related to serverless computing with Lambda, Step Functions, EventBridge, and SAM.
