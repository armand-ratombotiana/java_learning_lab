# Interview Questions - AWS Serverless

## Beginner Level

**Q1**: What is AWS Serverless and why is it important?
**A**: AWS Serverless is a fundamental concept addressing the challenges of building distributed systems at scale.

**Q2**: How do you handle errors in AWS Serverless implementations?
...
**Q4**: How would you design a fault-tolerant AWS Serverless system?
...
**Q10**: Design a AWS Serverless system for 1M requests/day.
