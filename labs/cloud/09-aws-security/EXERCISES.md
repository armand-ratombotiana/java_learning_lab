# 09 - AWS Security - Exercises

## Overview
Practice implementing AWS security services including IAM, KMS, WAF, Shield, and GuardDuty through these hands-on exercises.

## Exercise 1: Basic Implementation
Create a Java program that demonstrates core AWS Security concepts.
...
Build a system that integrates multiple components related to AWS security services including IAM, KMS, WAF, Shield, and GuardDuty.
