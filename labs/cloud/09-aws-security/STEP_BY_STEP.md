...
`ash
mkdir -p src/main/java/com/cloud/awssec
mkdir -p src/test/java/com/cloud/awssec
...
function GetVisualGuide {
    param(AWS Security, AWS security services including IAM, KMS, WAF, Shield, and GuardDuty)
    return @"
## System Overview
...
**AWS Security** operates by orchestrating multiple components in a coordinated workflow.
