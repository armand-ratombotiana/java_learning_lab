# 11 - AWS Observability - Exercises

## Overview
Practice implementing monitoring and observability with CloudWatch, X-Ray, Prometheus, AMP, and AMG through these hands-on exercises.

## Exercise 1: Basic Implementation
Create a Java program that demonstrates core AWS Observability concepts.
...
Build a system that integrates multiple components related to monitoring and observability with CloudWatch, X-Ray, Prometheus, AMP, and AMG.
