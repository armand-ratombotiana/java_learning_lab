# Security - AWS Observability

## Security Overview
Security is critical when implementing monitoring and observability with CloudWatch, X-Ray, Prometheus, AMP, and AMG. This document covers best practices.
