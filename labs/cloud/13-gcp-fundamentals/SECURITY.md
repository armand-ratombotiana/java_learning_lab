...
## Security Overview
Security is critical when implementing Google Cloud services including Compute Engine, Cloud Storage, Cloud SQL, GKE, and IAM. This document covers best practices.
