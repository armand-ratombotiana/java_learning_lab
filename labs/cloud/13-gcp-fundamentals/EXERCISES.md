# 13 - GCP Fundamentals - Exercises

## Overview
Practice implementing Google Cloud services including Compute Engine, Cloud Storage, Cloud SQL, GKE, and IAM through these hands-on exercises.

## Exercise 1: Basic Implementation
Create a Java program that demonstrates core GCP Fundamentals concepts.
...
Build a system that integrates multiple components related to Google Cloud services including Compute Engine, Cloud Storage, Cloud SQL, GKE, and IAM.
