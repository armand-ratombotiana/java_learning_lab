# Step by Step - Azure Fundamentals
...
`ash
mkdir -p src/main/java/com/cloud/azurefun
mkdir -p src/test/java/com/cloud/azurefun
...
**Azure Fundamentals** operates by orchestrating multiple components in a coordinated workflow.
