# Security - Azure Fundamentals

## Security Overview
Security is critical when implementing Azure cloud services including VMs, Blob Storage, Azure SQL, AKS, and managed identities. This document covers best practices.
