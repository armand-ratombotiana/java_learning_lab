...
### Q1: What is the Event Driven Architecture and what problem does it solve?
**A:** The Event Driven Architecture is an architectural pattern that addresses challenges in distributed systems. It provides a structured approach to managing complexity, enabling loose coupling, and improving system resilience.
