# Interview Questions: Api Composition

## Beginner Level

### Q1: What is the Api Composition and what problem does it solve?
**A:** The Api Composition is an architectural pattern that addresses challenges in distributed systems. It provides a structured approach to managing complexity, enabling loose coupling, and improving system resilience.
