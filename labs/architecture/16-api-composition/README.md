...
## Overview
API gateway composition, GraphQL federation, BFF composition, aggregate services

This lab provides a comprehensive, hands-on exploration of the **API Composition Pattern** with real-world Java implementations, architectural decision records, and production-ready patterns.
...
1. Understand when and why to apply the API Composition Pattern
