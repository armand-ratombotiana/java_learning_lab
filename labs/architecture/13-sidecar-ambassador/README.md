...
## Overview
Sidecar pattern, ambassador pattern, adapter pattern, Envoy sidecar

This lab provides a comprehensive, hands-on exploration of the **Sidecar & Ambassador Patterns** with real-world Java implementations, architectural decision records, and production-ready patterns.
...
1. Understand when and why to apply the Sidecar & Ambassador Patterns
