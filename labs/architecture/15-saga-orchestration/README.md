...
## Overview
Choreography vs orchestration, compensation, Axon Saga, Camunda

This lab provides a comprehensive, hands-on exploration of the **Saga Orchestration Pattern** with real-world Java implementations, architectural decision records, and production-ready patterns.
...
1. Understand when and why to apply the Saga Orchestration Pattern
