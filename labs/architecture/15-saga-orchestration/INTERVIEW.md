# Interview Questions: Saga Orchestration

## Beginner Level

### Q1: What is the Saga Orchestration and what problem does it solve?
**A:** The Saga Orchestration is an architectural pattern that addresses challenges in distributed systems. It provides a structured approach to managing complexity, enabling loose coupling, and improving system resilience.
