...
## Overview
BFF per client type, GraphQL BFF, aggregation

This lab provides a comprehensive, hands-on exploration of the **Backend for Frontend (BFF)** with real-world Java implementations, architectural decision records, and production-ready patterns.
...
1. Understand when and why to apply the Backend for Frontend (BFF)
