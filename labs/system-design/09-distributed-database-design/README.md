# Lab 09: Distributed Database Design

## Overview
Sharding, replication, consistent hashing, read replicas

This lab provides comprehensive coverage of all major concepts, implementations,
and best practices for Distributed Database Design. Through detailed theory, code deep dives,
...
## What You Will Learn
- Core concepts and architecture of Distributed Database Design
...
## Quick Start
```bash
cd 09-distributed-database-design
