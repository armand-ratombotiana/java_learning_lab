...
public record PaymentsystemService(String serviceId, int version, boolean enabled) {
    private static final Logger LOG = Logger.getLogger(PaymentsystemService.class.getName());
