...
public record RealtimecollabService(String serviceId, int version, boolean enabled) {
    private static final Logger LOG = Logger.getLogger(RealtimecollabService.class.getName());
    private static final ConcurrentHashMap<String, Object> store = new ConcurrentHashMap<>();
    private static final AtomicLong requestCounter = new AtomicLong(0);

    public RealtimecollabService {
