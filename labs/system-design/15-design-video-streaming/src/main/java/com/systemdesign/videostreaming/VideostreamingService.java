...
public record VideostreamingService(String serviceId, int version, boolean enabled) {
    private static final Logger LOG = Logger.getLogger(VideostreamingService.class.getName());
