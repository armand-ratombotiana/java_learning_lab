# Architectural Patterns for structured concurrency and scoped values

## Layered Architecture

structured concurrency and scoped values features fit into a layered architecture. Each layer provides abstractions that build on lower-level mechanisms.
...
### Framework Layer
Application frameworks (Spring, Quarkus, etc.) integrate structured concurrency and scoped values features into their programming models.
...
Integrating structured concurrency and scoped values features into existing systems requires careful planning. Consider compatibility, migration strategy, and operational impact.