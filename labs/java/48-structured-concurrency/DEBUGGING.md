# Debugging structured concurrency and scoped values Issues

## Common Symptoms

Issues with structured concurrency and scoped values manifest in several ways. Performance degradation, unexpected behavior, hangs, crashes, and resource exhaustion are common symptoms. Understanding the symptom helps narrow down the root cause.

## Diagnostic Tools

Several tools are available for diagnosing structured concurrency and scoped values issues:
