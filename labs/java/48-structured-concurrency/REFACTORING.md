# Refactoring for structured concurrency and scoped values

## Why Refactor?

Refactoring structured concurrency and scoped values code improves maintainability, performance, and correctness. As requirements evolve and understanding deepens, code that was once appropriate may need revision.
...
When reviewing structured concurrency and scoped values refactoring:
