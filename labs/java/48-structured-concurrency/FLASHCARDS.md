# Structured Concurrency & Scoped Values — Flashcards

## Card 1
**Front:** What is structured concurrency and scoped values?
**Back:** A set of Java platform features for StructuredTaskScope (ShutdownOnSuccess, ShutdownOnFailure) that provides improved performance, safety, and developer productivity.
