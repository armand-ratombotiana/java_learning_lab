# Structured Concurrency & Scoped Values — Reflection Prompts

## Section 1: Knowledge Check

1. Without looking at any reference, list the key structured concurrency and scoped values mechanisms available in Java 21. How many did you remember?
...
10. Profile an application and identify performance bottlenecks. What structured concurrency and scoped values techniques could address them?
...
13. Rate your understanding of each structured concurrency and scoped values area from 1 (struggling) to 5 (expert):
...
14. What aspect of structured concurrency and scoped values do you find most challenging? Why? What would help clarify it?

15. Have you encountered a production issue related to structured concurrency and scoped values? What was the root cause and how was it resolved?