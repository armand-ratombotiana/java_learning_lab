# Performance of structured concurrency and scoped values

## Performance Characteristics

Understanding the performance characteristics of structured concurrency and scoped values approaches is essential for making informed design decisions.
...
### Allocation Rate
Allocation rate directly impacts GC behavior and application throughput. Understanding allocation patterns in structured concurrency and scoped values code helps optimize memory management.
