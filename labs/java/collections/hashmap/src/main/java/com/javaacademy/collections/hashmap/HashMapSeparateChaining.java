...
/**
 * A hash map implemented using separate chaining with an array of buckets,
 * each bucket being a linked list of key-value entries.
 *
 * <p>This implementation demonstrates the classic hash table design:
 * <ul>
 *   <li>An array of buckets (each bucket holds a linked list of entries)</li>
 *   <li>Index computation via {@code hashCode() % capacity}</li>
 *   <li>Collision resolution by appending to the linked list at the bucket</li>
 *   <li>Automatic rehashing when the load factor exceeds 0.75</li>
 * </ul>
 *
