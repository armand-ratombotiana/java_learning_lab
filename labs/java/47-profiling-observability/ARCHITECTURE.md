# Architectural Patterns for profiling and observability

## Layered Architecture

profiling and observability features fit into a layered architecture. Each layer provides abstractions that build on lower-level mechanisms.
...
### Framework Layer
Application frameworks (Spring, Quarkus, etc.) integrate profiling and observability features into their programming models.
...
Integrating profiling and observability features into existing systems requires careful planning. Consider compatibility, migration strategy, and operational impact.