# G1 Garbage Collector — Reflection

## Guided Reflection Prompts

### Understanding
1. Before studying this micro-lab, what was your understanding of G1 Garbage Collector?
...
### Application
4. In your current projects, where would G1 Garbage Collector be the right choice?
5. Where have you seen G1 Garbage Collector used incorrectly in codebases you've worked with?
6. Can you think of a system that would fail without the correct choice?

### Design Trade-offs
7. What design trade-offs does G1 Garbage Collector make and why?
...
### Deeper Questions
10. How does G1 Garbage Collector interact with the Java Memory Model?
11. What role does G1 Garbage Collector play in concurrent systems?
12. How does garbage collection behavior affect the choice?
13. What are the limits? When should you use a database instead?

### Teaching Others
14. How would you explain G1 Garbage Collector to a junior developer?
...
17. How does G1 Garbage Collector relate to operating system data structures?
