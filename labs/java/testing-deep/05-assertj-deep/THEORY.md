# AssertJ Deep Dive -- Theoretical Foundation
## Core Concepts
### 1. Testing Fundamentals
Software testing verifies that code behaves as expected. The AssertJ Deep Dive provides a framework for writing and running tests.
### 2. Test Pyramid
