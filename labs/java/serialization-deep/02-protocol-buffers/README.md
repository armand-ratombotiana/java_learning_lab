...
## Overview
Proto3 schema, protoc compilation, generated builders, JSON/bytes serialization, field types, oneof, maps

## Learning Objectives
- Understand the internal mechanics of Protocol Buffers
