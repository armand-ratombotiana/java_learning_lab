...
## Overview
Kryo serialization, registration, thread-safe serializer, field vs field serializer, performance comparisons

## Learning Objectives
- Understand the internal mechanics of Kryo Serialization
