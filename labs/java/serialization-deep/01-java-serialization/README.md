...
## Overview
ObjectOutputStream/ObjectInputStream, serialVersionUID, writeObject/readObject, readResolve/writeReplace, Externalizable, serialization proxy pattern

## Learning Objectives
- Understand the internal mechanics of Java Serialization
