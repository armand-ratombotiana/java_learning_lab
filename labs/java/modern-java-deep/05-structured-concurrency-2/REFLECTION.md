# Structured Concurrency 2 — Reflection

## Guided Reflection Prompts

### Understanding
1. Before studying this micro-lab, what was your understanding of Structured Concurrency 2?
...
### Application
4. In your current projects, where would Structured Concurrency 2 be the right choice?
5. Where have you seen Structured Concurrency 2 used incorrectly in codebases you've worked with?
6. Can you think of a system that would fail without the correct choice?

### Design Trade-offs
7. What design trade-offs does Structured Concurrency 2 make and why?
...
### Deeper Questions
10. How does Structured Concurrency 2 interact with the Java Memory Model?
11. What role does Structured Concurrency 2 play in concurrent systems?
12. How does garbage collection behavior affect the choice?
13. What are the limits? When should you use a database instead?

### Teaching Others
14. How would you explain Structured Concurrency 2 to a junior developer?
...
17. How does Structured Concurrency 2 relate to operating system data structures?
