# Structured Concurrency 2 — Theoretical Foundation

## Core Concepts

### 1. Fundamental Principle
StructuredTaskScope internals, ShutdownOnSuccess/Failure, scope hierarchy, JEP 462

### 2. Theoretical Foundation
The Structured Concurrency 2 is built on well-established computer science principles that govern how data structures
...
## Summary
The Structured Concurrency 2 represents a careful balance of theoretical computer science principles applied to
