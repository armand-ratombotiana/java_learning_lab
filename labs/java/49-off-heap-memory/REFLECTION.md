# Off-Heap Memory & Direct Buffers — Reflection Prompts

## Section 1: Knowledge Check

1. Without looking at any reference, list the key off-heap memory and direct buffers mechanisms available in Java 21. How many did you remember?
...
10. Profile an application and identify performance bottlenecks. What off-heap memory and direct buffers techniques could address them?
...
13. Rate your understanding of each off-heap memory and direct buffers area from 1 (struggling) to 5 (expert):
...
14. What aspect of off-heap memory and direct buffers do you find most challenging? Why? What would help clarify it?

15. Have you encountered a production issue related to off-heap memory and direct buffers? What was the root cause and how was it resolved?