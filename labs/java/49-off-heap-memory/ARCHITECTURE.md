# Architectural Patterns for off-heap memory and direct buffers

## Layered Architecture

off-heap memory and direct buffers features fit into a layered architecture. Each layer provides abstractions that build on lower-level mechanisms.
...
### Framework Layer
Application frameworks (Spring, Quarkus, etc.) integrate off-heap memory and direct buffers features into their programming models.
...
Integrating off-heap memory and direct buffers features into existing systems requires careful planning. Consider compatibility, migration strategy, and operational impact.