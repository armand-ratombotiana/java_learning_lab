# Debugging off-heap memory and direct buffers Issues

## Common Symptoms

Issues with off-heap memory and direct buffers manifest in several ways. Performance degradation, unexpected behavior, hangs, crashes, and resource exhaustion are common symptoms. Understanding the symptom helps narrow down the root cause.

## Diagnostic Tools

Several tools are available for diagnosing off-heap memory and direct buffers issues:
