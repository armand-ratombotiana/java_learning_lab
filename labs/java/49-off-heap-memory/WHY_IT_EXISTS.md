# Why off-heap memory and direct buffers Exists

## The Problem

Modern Java applications face increasingly complex requirements for off-heap memory and direct buffers. As systems grow in scale and sophistication, the limitations of earlier approaches become apparent. The need for better abstractions, improved performance, and stronger safety guarantees drove the evolution of off-heap memory and direct buffers in the Java ecosystem.
...
The designers of the Java platform established several goals for off-heap memory and direct buffers:
