# Off-Heap Memory & Direct Buffers — Flashcards

## Card 1
**Front:** What is off-heap memory and direct buffers?
**Back:** A set of Java platform features for DirectByteBuffer allocation and -XX:MaxDirectMemorySize that provides improved performance, safety, and developer productivity.
