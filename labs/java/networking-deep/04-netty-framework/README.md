# Netty Framework
## Overview
ChannelHandler pipeline, EventLoopGroup, ChannelFuture, ByteBuf, Netty HTTP server, TCP server, codecs
## Learning Objectives
- Understand the internal mechanics of Netty Framework
...
## Quick Start
1. Navigate to the source directory: src/main/java/com/javalab/04/
