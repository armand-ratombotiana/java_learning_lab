# HTTP Clients (Java 11+)
## Overview
HttpClient (Java 11+), HTTP/2, WebSocket, reactive client, connection pooling, timeout/retry configuration
## Learning Objectives
- Understand the internal mechanics of HTTP Clients (Java 11+)
