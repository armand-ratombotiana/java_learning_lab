# GC Log Analysis — Quiz

## Question 1: Fundamentals
What is the average time complexity of the primary lookup operation in GC Log Analysis?
- A) O(1)
- B) O(log n)
- C) O(n)
- D) O(n log n)
...
## Question 3: Memory
How much additional memory overhead does GC Log Analysis have per element (approximately)?

## Question 4: Concurrency
Is GC Log Analysis safe for concurrent access without external synchronization? Explain why or why not.

## Question 5: Scalability
How does GC Log Analysis perform as the number of elements grows from 10 to 10 million? What factors degrade performance?

## Question 6: Design
Why was GC Log Analysis designed this way? What alternatives were considered during its development?
...
Compare GC Log Analysis with the most similar alternative in the Java collections framework.
List 3 advantages and 3 disadvantages of each.

## Question 9: Real-World
Describe a real-world scenario where GC Log Analysis is the optimal choice.
