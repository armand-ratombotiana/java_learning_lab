# Profiling with async-profiler — How It Works

## Mechanical Explanation

### The Core Mechanism
Profiling with async-profiler works by organizing data in a specific structure that enables efficient operations.
