# Advanced Concurrency Patterns — Flashcards

## Card 1
**Front:** What is advanced concurrency patterns?
**Back:** A set of Java platform features for Actor model with mailbox pattern that provides improved performance, safety, and developer productivity.
