# Architectural Patterns for advanced concurrency patterns

## Layered Architecture

advanced concurrency patterns features fit into a layered architecture. Each layer provides abstractions that build on lower-level mechanisms.
...
### Framework Layer
Application frameworks (Spring, Quarkus, etc.) integrate advanced concurrency patterns features into their programming models.
...
Integrating advanced concurrency patterns features into existing systems requires careful planning. Consider compatibility, migration strategy, and operational impact.