...
Welcome to Lab 15 of the Data Science Academy. This lab provides an in-depth exploration of Data Pipelines.

## Overview

Feature engineering pipelines, data transforms, imputation, encoding, scaling, pipeline orchestration, column transformers
...
1. Implement core Data Pipelines algorithms in pure Java
...
All source code is in the `com.datasci.lab15` package under `src/main/java/`. Tests are in `src/test/java/`.
