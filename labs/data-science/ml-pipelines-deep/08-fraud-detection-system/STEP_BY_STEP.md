# Step-by-Step Guide: Fraud Detection System

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/frauddetection
mkdir -p src/test/java/com/mathlab/frauddetection
`
...
`java
@Test void testBasic() {
    assertEquals(expected, FraudDetectionSystem.compute(input), 1e-10);
}
`
