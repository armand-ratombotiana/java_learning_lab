# Step-by-Step Guide: Model Evaluation

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/modelevaluation
mkdir -p src/test/java/com/mathlab/modelevaluation
`
...
`java
@Test void testBasic() {
    assertEquals(expected, ModelEvaluation.compute(input), 1e-10);
}
`
