# Step-by-Step Guide: Model Serving

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/modelserving
mkdir -p src/test/java/com/mathlab/modelserving
`
...
`java
@Test void testBasic() {
    assertEquals(expected, ModelServing.compute(input), 1e-10);
}
`
