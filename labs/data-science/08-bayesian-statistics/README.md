...
Welcome to Lab 08 of the Data Science Academy. This lab provides an in-depth exploration of Bayesian Statistics.

## Overview

Bayesian inference, conjugate priors, MCMC sampling, Metropolis-Hastings, Gibbs sampling, prior/posterior distributions, credible intervals, Bayes factors
...
1. Implement core Bayesian Statistics algorithms in pure Java
...
All source code is in the `com.datasci.lab08` package under `src/main/java/`. Tests are in `src/test/java/`.
