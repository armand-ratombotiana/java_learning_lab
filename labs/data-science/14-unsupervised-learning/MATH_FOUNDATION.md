...
Matrix operations, eigenvectors, eigenvalues, and SVD are fundamental to Unsupervised Learning. The eigendecomposition A = Q * Lambda * Q^(-1) where columns of Q are eigenvectors and Lambda contains eigenvalues. SVD generalizes to non-square matrices: A = U * Sigma * V^T.
