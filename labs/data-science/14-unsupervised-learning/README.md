...
Welcome to Lab 14 of the Data Science Academy. This lab provides an in-depth exploration of Unsupervised Learning.

## Overview

Autoencoders, manifold learning, anomaly detection, clustering metrics, isolation forest, one-class SVM
...
1. Implement core Unsupervised Learning algorithms in pure Java
...
All source code is in the `com.datasci.lab14` package under `src/main/java/`. Tests are in `src/test/java/`.
