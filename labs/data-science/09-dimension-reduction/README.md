...
Welcome to Lab 09 of the Data Science Academy. This lab provides an in-depth exploration of Dimensionality Reduction.

## Overview

PCA, t-SNE, UMAP, feature selection, variance threshold, eigenvalues, singular value decomposition, explained variance
...
1. Implement core Dimensionality Reduction algorithms in pure Java
...
All source code is in the `com.datasci.lab09` package under `src/main/java/`. Tests are in `src/test/java/`.
