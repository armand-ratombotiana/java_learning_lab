# Step-by-Step Guide: Descriptive Statistics

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/descriptivestats
mkdir -p src/test/java/com/mathlab/descriptivestats
`
...
`java
@Test void testBasic() {
    assertEquals(expected, DescriptiveStatistics.compute(input), 1e-10);
}
`
