# Step-by-Step Guide: Experimentation and A/B Testing

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/experimentation
mkdir -p src/test/java/com/mathlab/experimentation
`
...
`java
@Test void testBasic() {
    assertEquals(expected, Experimentation.compute(input), 1e-10);
}
`
