# Step-by-Step Guide: Anomaly Detection Advanced

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/anomalydetection
mkdir -p src/test/java/com/mathlab/anomalydetection
`
...
`java
@Test void testBasic() {
    assertEquals(expected, AnomalyDetection.compute(input), 1e-10);
}
`
