# Step-by-Step Guide: Data Wrangling

## Implementation Walkthrough

### Step 1: Set Up Project Structure
`ash
mkdir -p src/main/java/com/mathlab/datawrangling
mkdir -p src/test/java/com/mathlab/datawrangling
`
...
`java
@Test void testBasic() {
    assertEquals(expected, DataWrangling.compute(input), 1e-10);
}
`
