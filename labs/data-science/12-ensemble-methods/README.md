...
Welcome to Lab 12 of the Data Science Academy. This lab provides an in-depth exploration of Ensemble Methods.

## Overview

Random Forest, Gradient Boosting, XGBoost, stacking, bagging, AdaBoost, voting classifiers, out-of-bag error
...
1. Implement core Ensemble Methods algorithms in pure Java
