...
Welcome to Lab 11 of the Data Science Academy. This lab provides an in-depth exploration of Advanced NLP.

## Overview

Tokenization, TF-IDF, word embeddings, LDA topic modeling, text classification, Naive Bayes, cosine similarity
...
1. Implement core Advanced NLP algorithms in pure Java
...
All source code is in the `com.datasci.lab11` package under `src/main/java/`. Tests are in `src/test/java/`.
