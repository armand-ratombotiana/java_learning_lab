...
/**
 * Core implementation for 07-dim-reduction-pca micro-lab.
 * Provides production-quality implementation of 07-dim-reduction-pca concepts.
 *
...
public class PcaAlgorithm {
     ...
     */
    public PcaAlgorithm(double learningRate, int maxIterations, double tolerance) {
