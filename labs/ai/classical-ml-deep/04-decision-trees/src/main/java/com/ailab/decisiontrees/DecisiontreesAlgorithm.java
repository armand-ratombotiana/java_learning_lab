...
/**
 * Core implementation for 04-decision-trees micro-lab.
 * Provides production-quality implementation of 04-decision-trees concepts.
 *
...
public class DecisiontreesAlgorithm {
     ...
     */
    public DecisiontreesAlgorithm(double learningRate, int maxIterations, double tolerance) {
