...
/**
 * JUnit 5 test suite for DecisiontreesAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class DecisiontreesAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new DecisiontreesAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new DecisiontreesAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new DecisiontreesAlgorithm(0.1, 100, 1e-10);
