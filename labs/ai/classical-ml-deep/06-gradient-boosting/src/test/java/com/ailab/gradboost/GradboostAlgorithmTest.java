...
/**
 * JUnit 5 test suite for GradboostAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class GradboostAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new GradboostAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new GradboostAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new GradboostAlgorithm(0.1, 100, 1e-10);
