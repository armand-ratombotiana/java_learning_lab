...
/**
 * Core implementation for 06-gradient-boosting micro-lab.
 * Provides production-quality implementation of 06-gradient-boosting concepts.
 *
 ...
 */
public class GradboostAlgorithm {
     ...
     */
    public GradboostAlgorithm(double learningRate, int maxIterations, double tolerance) {
