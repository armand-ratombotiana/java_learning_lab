...
/**
 * Core implementation for 08-clustering-kmeans micro-lab.
 * Provides production-quality implementation of 08-clustering-kmeans concepts.
 *
...
public class KmeansAlgorithm {
     ...
     */
    public KmeansAlgorithm(double learningRate, int maxIterations, double tolerance) {
