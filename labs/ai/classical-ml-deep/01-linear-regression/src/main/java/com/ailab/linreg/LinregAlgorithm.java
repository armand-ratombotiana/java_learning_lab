...
/**
 * Core implementation for 01-linear-regression micro-lab.
 * Provides production-quality implementation of 01-linear-regression concepts.
 *
...
public class LinregAlgorithm {
     ...
     */
    public LinregAlgorithm(double learningRate, int maxIterations, double tolerance) {
