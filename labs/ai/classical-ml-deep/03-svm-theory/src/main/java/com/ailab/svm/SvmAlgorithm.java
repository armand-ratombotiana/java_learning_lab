...
/**
 * Core implementation for 03-svm-theory micro-lab.
 * Provides production-quality implementation of 03-svm-theory concepts.
 *
...
public class SvmAlgorithm {
     ...
     */
    public SvmAlgorithm(double learningRate, int maxIterations, double tolerance) {
