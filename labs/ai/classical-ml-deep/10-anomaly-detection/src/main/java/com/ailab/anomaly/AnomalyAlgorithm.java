...
/**
 * Core implementation for 10-anomaly-detection micro-lab.
 * Provides production-quality implementation of 10-anomaly-detection concepts.
 *
...
public class AnomalyAlgorithm {
     ...
     */
    public AnomalyAlgorithm(double learningRate, int maxIterations, double tolerance) {
