...
/**
 * Core implementation for 02-logistic-regression micro-lab.
 * Provides production-quality implementation of 02-logistic-regression concepts.
 *
...
public class LogregAlgorithm {
     ...
     */
    public LogregAlgorithm(double learningRate, int maxIterations, double tolerance) {
