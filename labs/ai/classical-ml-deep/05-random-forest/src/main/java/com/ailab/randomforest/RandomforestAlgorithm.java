...
/**
 * Core implementation for 05-random-forest micro-lab.
 * Provides production-quality implementation of 05-random-forest concepts.
 *
...
public class RandomforestAlgorithm {
     ...
     */
    public RandomforestAlgorithm(double learningRate, int maxIterations, double tolerance) {
