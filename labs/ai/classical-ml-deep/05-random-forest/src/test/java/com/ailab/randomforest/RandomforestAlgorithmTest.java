...
/**
 * JUnit 5 test suite for RandomforestAlgorithm.
...
class RandomforestAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new RandomforestAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new RandomforestAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new RandomforestAlgorithm(0.1, 100, 1e-10);
