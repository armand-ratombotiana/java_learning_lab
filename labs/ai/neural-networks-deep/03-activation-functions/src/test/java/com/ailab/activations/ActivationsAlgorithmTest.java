...
/**
 * JUnit 5 test suite for ActivationsAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class ActivationsAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new ActivationsAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new ActivationsAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new ActivationsAlgorithm(0.1, 100, 1e-10);
