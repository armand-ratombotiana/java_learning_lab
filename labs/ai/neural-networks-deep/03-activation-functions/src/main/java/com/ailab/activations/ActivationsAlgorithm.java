...
/**
 * Core implementation for 03-activation-functions micro-lab.
 * Provides production-quality implementation of 03-activation-functions concepts.
 *
 ...
 */
public class ActivationsAlgorithm {
     ...
     */
    public ActivationsAlgorithm(double learningRate, int maxIterations, double tolerance) {
