...
/**
 * JUnit 5 test suite for RegularizationAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class RegularizationAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new RegularizationAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new RegularizationAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new RegularizationAlgorithm(0.1, 100, 1e-10);
