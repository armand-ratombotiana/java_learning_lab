...
/**
 * Core implementation for 08-normalization-layers micro-lab.
 * Provides production-quality implementation of 08-normalization-layers concepts.
 *
...
public class NormalizationAlgorithm {
     ...
     */
    public NormalizationAlgorithm(double learningRate, int maxIterations, double tolerance) {
