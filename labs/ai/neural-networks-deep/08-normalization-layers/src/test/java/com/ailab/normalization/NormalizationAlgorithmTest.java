...
/**
 * JUnit 5 test suite for NormalizationAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class NormalizationAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new NormalizationAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new NormalizationAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new NormalizationAlgorithm(0.1, 100, 1e-10);
