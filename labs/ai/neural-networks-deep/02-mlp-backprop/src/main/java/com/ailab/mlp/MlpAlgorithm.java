...
/**
 * Core implementation for 02-mlp-backprop micro-lab.
 * Provides production-quality implementation of 02-mlp-backprop concepts.
 *
...
public class MlpAlgorithm {
     ...
     */
    public MlpAlgorithm(double learningRate, int maxIterations, double tolerance) {
