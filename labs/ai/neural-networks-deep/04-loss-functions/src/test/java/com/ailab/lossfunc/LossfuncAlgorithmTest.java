...
/**
 * JUnit 5 test suite for LossfuncAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class LossfuncAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new LossfuncAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new LossfuncAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new LossfuncAlgorithm(0.1, 100, 1e-10);
