...
/**
 * Core implementation for 06-weight-initialization micro-lab.
 * Provides production-quality implementation of 06-weight-initialization concepts.
 *
...
public class InitAlgorithm {
     ...
     */
    public InitAlgorithm(double learningRate, int maxIterations, double tolerance) {
