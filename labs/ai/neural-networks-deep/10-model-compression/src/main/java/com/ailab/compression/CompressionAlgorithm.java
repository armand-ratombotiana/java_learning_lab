...
/**
 * Core implementation for 10-model-compression micro-lab.
 * Provides production-quality implementation of 10-model-compression concepts.
 *
...
public class CompressionAlgorithm {
     ...
     */
    public CompressionAlgorithm(double learningRate, int maxIterations, double tolerance) {
