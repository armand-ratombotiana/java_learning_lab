...
/**
 * Core implementation for 01-perceptron micro-lab.
 * Provides production-quality implementation of 01-perceptron concepts.
 *
...
public class PerceptronAlgorithm {
     ...
     */
    public PerceptronAlgorithm(double learningRate, int maxIterations, double tolerance) {
