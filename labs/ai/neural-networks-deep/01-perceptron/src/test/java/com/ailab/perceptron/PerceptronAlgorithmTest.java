...
/**
 * JUnit 5 test suite for PerceptronAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class PerceptronAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new PerceptronAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new PerceptronAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new PerceptronAlgorithm(0.1, 100, 1e-10);
