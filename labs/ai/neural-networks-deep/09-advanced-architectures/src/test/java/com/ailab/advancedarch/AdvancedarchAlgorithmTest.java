...
/**
 * JUnit 5 test suite for AdvancedarchAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class AdvancedarchAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new AdvancedarchAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new AdvancedarchAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new AdvancedarchAlgorithm(0.1, 100, 1e-10);
