...
/**
 * JUnit 5 test suite for OptimizersAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class OptimizersAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new OptimizersAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new OptimizersAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new OptimizersAlgorithm(0.1, 100, 1e-10);
