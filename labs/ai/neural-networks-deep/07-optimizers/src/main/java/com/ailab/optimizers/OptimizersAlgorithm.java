...
/**
 * Core implementation for 07-optimizers micro-lab.
 * Provides production-quality implementation of 07-optimizers concepts.
 *
 ...
 */
public class OptimizersAlgorithm {
     ...
     */
    public OptimizersAlgorithm(double learningRate, int maxIterations, double tolerance) {
