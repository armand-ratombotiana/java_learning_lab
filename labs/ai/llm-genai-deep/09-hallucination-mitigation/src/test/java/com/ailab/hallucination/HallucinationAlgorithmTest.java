...
/**
 * JUnit 5 test suite for HallucinationAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class HallucinationAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new HallucinationAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new HallucinationAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new HallucinationAlgorithm(0.1, 100, 1e-10);
