...
/**
 * JUnit 5 test suite for AisafetyAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class AisafetyAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new AisafetyAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new AisafetyAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new AisafetyAlgorithm(0.1, 100, 1e-10);
