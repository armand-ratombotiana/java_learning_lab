...
/**
 * JUnit 5 test suite for PromptengAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class PromptengAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new PromptengAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new PromptengAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new PromptengAlgorithm(0.1, 100, 1e-10);
