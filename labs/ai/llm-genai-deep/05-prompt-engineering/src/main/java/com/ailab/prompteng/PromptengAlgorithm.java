...
/**
 * Core implementation for 05-prompt-engineering micro-lab.
 * Provides production-quality implementation of 05-prompt-engineering concepts.
 *
 ...
 */
public class PromptengAlgorithm {
     ...
     */
    public PromptengAlgorithm(double learningRate, int maxIterations, double tolerance) {
