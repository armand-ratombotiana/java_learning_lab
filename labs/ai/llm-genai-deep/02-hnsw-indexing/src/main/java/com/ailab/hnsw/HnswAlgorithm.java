...
/**
 * Core implementation for 02-hnsw-indexing micro-lab.
 * Provides production-quality implementation of 02-hnsw-indexing concepts.
 *
...
public class HnswAlgorithm {
     ...
     */
    public HnswAlgorithm(double learningRate, int maxIterations, double tolerance) {
