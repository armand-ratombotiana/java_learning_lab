...
class HnswAlgorithmTest {
    ...
    void testCustomInitialization() {
        var algo = new HnswAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new HnswAlgorithm(0.1, 100, 1e-10);
