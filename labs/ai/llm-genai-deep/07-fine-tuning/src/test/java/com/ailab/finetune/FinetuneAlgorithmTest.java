...
/**
 * JUnit 5 test suite for FinetuneAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class FinetuneAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new FinetuneAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new FinetuneAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new FinetuneAlgorithm(0.1, 100, 1e-10);
