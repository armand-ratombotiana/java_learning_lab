...
/**
 * JUnit 5 test suite for EmbeddingsAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class EmbeddingsAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new EmbeddingsAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new EmbeddingsAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new EmbeddingsAlgorithm(0.1, 100, 1e-10);
