...
/**
 * Core implementation for 01-embeddings-semantic micro-lab.
 * Provides production-quality implementation of 01-embeddings-semantic concepts.
 *
 ...
 */
public class EmbeddingsAlgorithm {
     ...
     */
    public EmbeddingsAlgorithm(double learningRate, int maxIterations, double tolerance) {
