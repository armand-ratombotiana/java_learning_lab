...
/**
 * Core implementation for 06-llm-agents micro-lab.
 * Provides production-quality implementation of 06-llm-agents concepts.
 *
...
public class AgentsAlgorithm {
     ...
     */
    public AgentsAlgorithm(double learningRate, int maxIterations, double tolerance) {
