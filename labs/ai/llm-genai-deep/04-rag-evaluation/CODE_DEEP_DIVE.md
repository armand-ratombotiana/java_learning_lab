# Code Deep Dive: 04-rag-evaluation

## 1. Architecture Overview
The Java implementation in `com.ailab.rageval` follows clean architecture principles. The code is organized into clear layers: data structures, core algorithm, utilities, and configuration. Each layer has a well-defined responsibility and interface.

### 1.1 Package Structure
The `com.ailab.rageval` package contains:
- Main algorithm class implementing 04-rag-evaluation concepts
