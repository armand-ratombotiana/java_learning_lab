...
/**
 * Core implementation for 04-rag-evaluation micro-lab.
 * Provides production-quality implementation of 04-rag-evaluation concepts.
 *
...
public class RagevalAlgorithm {
     ...
     */
    public RagevalAlgorithm(double learningRate, int maxIterations, double tolerance) {
