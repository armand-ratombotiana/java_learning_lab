...
/**
 * JUnit 5 test suite for MatricesopsAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class MatricesopsAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new MatricesopsAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new MatricesopsAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new MatricesopsAlgorithm(0.1, 100, 1e-10);
