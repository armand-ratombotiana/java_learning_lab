...
/**
 * Core implementation for 06-bayesian-inference micro-lab.
 * Provides production-quality implementation of 06-bayesian-inference concepts.
 *
...
public class BayesianAlgorithm {
     ...
     */
    public BayesianAlgorithm(double learningRate, int maxIterations, double tolerance) {
