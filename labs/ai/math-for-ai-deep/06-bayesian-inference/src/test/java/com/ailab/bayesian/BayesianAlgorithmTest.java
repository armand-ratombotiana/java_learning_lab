...
/**
 * JUnit 5 test suite for BayesianAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class BayesianAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new BayesianAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new BayesianAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new BayesianAlgorithm(0.1, 100, 1e-10);
