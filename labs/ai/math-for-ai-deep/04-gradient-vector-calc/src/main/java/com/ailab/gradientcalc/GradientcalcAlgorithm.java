...
/**
 * Core implementation for 04-gradient-vector-calc micro-lab.
 * Provides production-quality implementation of 04-gradient-vector-calc concepts.
 *
 ...
 */
public class GradientcalcAlgorithm {
     ...
     */
    public GradientcalcAlgorithm(double learningRate, int maxIterations, double tolerance) {
