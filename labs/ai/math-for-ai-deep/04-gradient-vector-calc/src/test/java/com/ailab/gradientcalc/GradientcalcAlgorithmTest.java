...
/**
 * JUnit 5 test suite for GradientcalcAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class GradientcalcAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new GradientcalcAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new GradientcalcAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new GradientcalcAlgorithm(0.1, 100, 1e-10);
