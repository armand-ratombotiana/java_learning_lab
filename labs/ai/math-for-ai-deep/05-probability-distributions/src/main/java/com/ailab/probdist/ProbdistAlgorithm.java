...
/**
 * Core implementation for 05-probability-distributions micro-lab.
 * Provides production-quality implementation of 05-probability-distributions concepts.
 *
 ...
 */
public class ProbdistAlgorithm {
     ...
     */
    public ProbdistAlgorithm(double learningRate, int maxIterations, double tolerance) {
