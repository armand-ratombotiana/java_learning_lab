...
/**
 * JUnit 5 test suite for ProbdistAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class ProbdistAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new ProbdistAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new ProbdistAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new ProbdistAlgorithm(0.1, 100, 1e-10);
