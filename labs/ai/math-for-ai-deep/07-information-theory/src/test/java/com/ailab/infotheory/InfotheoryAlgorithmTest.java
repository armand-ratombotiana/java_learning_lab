...
/**
 * JUnit 5 test suite for InfotheoryAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class InfotheoryAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new InfotheoryAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new InfotheoryAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new InfotheoryAlgorithm(0.1, 100, 1e-10);
