...
/**
 * Core implementation for 07-information-theory micro-lab.
 * Provides production-quality implementation of 07-information-theory concepts.
 *
 ...
 */
public class InfotheoryAlgorithm {
     ...
     */
    public InfotheoryAlgorithm(double learningRate, int maxIterations, double tolerance) {
