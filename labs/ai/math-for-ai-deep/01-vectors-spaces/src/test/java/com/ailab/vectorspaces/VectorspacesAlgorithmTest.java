...
/**
 * JUnit 5 test suite for VectorspacesAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class VectorspacesAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new VectorspacesAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new VectorspacesAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new VectorspacesAlgorithm(0.1, 100, 1e-10);
