...
/**
 * Core implementation for 01-vectors-spaces micro-lab.
 * Provides production-quality implementation of 01-vectors-spaces concepts.
 *
 ...
 */
public class VectorspacesAlgorithm {
     ...
     */
    public VectorspacesAlgorithm(double learningRate, int maxIterations, double tolerance) {
