...
/**
 * JUnit 5 test suite for OptimizationAlgorithm.
...
class OptimizationAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new OptimizationAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new OptimizationAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new OptimizationAlgorithm(0.1, 100, 1e-10);
