...
/**
 * JUnit 5 test suite for GraddescentAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class GraddescentAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new GraddescentAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new GraddescentAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new GraddescentAlgorithm(0.1, 100, 1e-10);
