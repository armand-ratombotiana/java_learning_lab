...
/**
 * Core implementation for 09-gradient-descent-variants micro-lab.
 * Provides production-quality implementation of 09-gradient-descent-variants concepts.
 *
 ...
 */
public class GraddescentAlgorithm {
     ...
     */
    public GraddescentAlgorithm(double learningRate, int maxIterations, double tolerance) {
