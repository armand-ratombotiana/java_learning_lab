...
/**
 * JUnit 5 test suite for NumericalAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class NumericalAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new NumericalAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new NumericalAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new NumericalAlgorithm(0.1, 100, 1e-10);
