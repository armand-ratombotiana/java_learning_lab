...
/**
 * Core implementation for 10-numerical-computing micro-lab.
 * Provides production-quality implementation of 10-numerical-computing concepts.
 *
...
public class NumericalAlgorithm {
     ...
     */
    public NumericalAlgorithm(double learningRate, int maxIterations, double tolerance) {
