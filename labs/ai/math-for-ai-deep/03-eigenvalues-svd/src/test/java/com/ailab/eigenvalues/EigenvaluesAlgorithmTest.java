...
/**
 * JUnit 5 test suite for EigenvaluesAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class EigenvaluesAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new EigenvaluesAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new EigenvaluesAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new EigenvaluesAlgorithm(0.1, 100, 1e-10);
