...
/**
 * JUnit 5 test suite for InferenceAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class InferenceAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new InferenceAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new InferenceAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new InferenceAlgorithm(0.1, 100, 1e-10);
