...
/**
 * Core implementation for 10-inference-optimization micro-lab.
 * Provides production-quality implementation of 10-inference-optimization concepts.
 *
...
public class InferenceAlgorithm {
     ...
     */
    public InferenceAlgorithm(double learningRate, int maxIterations, double tolerance) {
