...
/**
 * Core implementation for 06-attention-variants micro-lab.
 * Provides production-quality implementation of 06-attention-variants concepts.
 *
 ...
 */
public class AttentionAlgorithm {
     ...
     */
    public AttentionAlgorithm(double learningRate, int maxIterations, double tolerance) {
