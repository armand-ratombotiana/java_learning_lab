...
/**
 * JUnit 5 test suite for AttentionAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class AttentionAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new AttentionAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new AttentionAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new AttentionAlgorithm(0.1, 100, 1e-10);
