...
/**
 * Core implementation for 05-transformer-from-scratch micro-lab.
 * Provides production-quality implementation of 05-transformer-from-scratch concepts.
 *
 ...
 */
public class TransformerAlgorithm {
     ...
     */
    public TransformerAlgorithm(double learningRate, int maxIterations, double tolerance) {
