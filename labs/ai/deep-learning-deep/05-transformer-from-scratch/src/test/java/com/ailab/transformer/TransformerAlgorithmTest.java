...
/**
 * JUnit 5 test suite for TransformerAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class TransformerAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new TransformerAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new TransformerAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new TransformerAlgorithm(0.1, 100, 1e-10);
