...
/**
 * Core implementation for 01-cnn-fundamentals micro-lab.
 * Provides production-quality implementation of 01-cnn-fundamentals concepts.
 *
...
public class CnnAlgorithm {
     ...
     */
    public CnnAlgorithm(double learningRate, int maxIterations, double tolerance) {
