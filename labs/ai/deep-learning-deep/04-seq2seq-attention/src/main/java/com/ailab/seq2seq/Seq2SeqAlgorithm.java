...
/**
 * Core implementation for 04-seq2seq-attention micro-lab.
 * Provides production-quality implementation of 04-seq2seq-attention concepts.
 *
...
public class Seq2SeqAlgorithm {
     ...
     */
    public Seq2SeqAlgorithm(double learningRate, int maxIterations, double tolerance) {
