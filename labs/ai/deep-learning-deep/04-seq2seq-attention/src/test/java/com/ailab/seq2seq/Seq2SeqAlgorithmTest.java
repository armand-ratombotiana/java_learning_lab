...
class Seq2SeqAlgorithmTest {
    ...
    void testCustomInitialization() {
        var algo = new Seq2SeqAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new Seq2SeqAlgorithm(0.1, 100, 1e-10);
