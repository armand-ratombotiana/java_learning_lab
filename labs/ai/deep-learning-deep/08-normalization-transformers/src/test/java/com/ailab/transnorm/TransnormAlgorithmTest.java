...
/**
 * JUnit 5 test suite for TransnormAlgorithm.
 * Tests initialization, training convergence, prediction accuracy,
 * and parameter configuration.
 */
class TransnormAlgorithmTest {
    ...
    void testDefaultInitialization() {
        var algo = new TransnormAlgorithm();
        assertNotNull(algo);
    ...
    void testCustomInitialization() {
        var algo = new TransnormAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new TransnormAlgorithm(0.1, 100, 1e-10);
