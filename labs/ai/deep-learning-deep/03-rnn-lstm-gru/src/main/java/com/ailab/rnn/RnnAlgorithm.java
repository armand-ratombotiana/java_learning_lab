...
/**
 * Core implementation for 03-rnn-lstm-gru micro-lab.
 * Provides production-quality implementation of 03-rnn-lstm-gru concepts.
 *
...
public class RnnAlgorithm {
     ...
     */
    public RnnAlgorithm(double learningRate, int maxIterations, double tolerance) {
