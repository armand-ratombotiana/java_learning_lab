...
class CnnarchAlgorithmTest {
    ...
    void testCustomInitialization() {
        var algo = new CnnarchAlgorithm(0.1, 500, 1e-8);
    ...
    void testLossDecreases() {
        var algo = new CnnarchAlgorithm(0.1, 100, 1e-10);
