...
/**
 * Core implementation for 02-cnn-architectures micro-lab.
 * Provides production-quality implementation of 02-cnn-architectures concepts.
 *
...
public class CnnarchAlgorithm {
     ...
     */
    public CnnarchAlgorithm(double learningRate, int maxIterations, double tolerance) {
