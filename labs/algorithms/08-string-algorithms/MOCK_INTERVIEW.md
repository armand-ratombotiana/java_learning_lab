...
## Question 1: Find the Index of First Occurrence (LC 28)

**Difficulty**: Easy
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Find the Index of First Occurrence (LC 28). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the String Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Repeated DNA Sequences (LC 187)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Repeated DNA Sequences (LC 187). This is a more challenging algorithmic problem."
...
## Question 3: Longest Duplicate Substring (LC 1044)

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Longest Duplicate Substring (LC 1044). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced String Algorithms | Harder variations | Solve 5 more problems in this paradigm |
