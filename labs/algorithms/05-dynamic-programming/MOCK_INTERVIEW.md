...
## Question 1: Climbing Stairs (LC 70)

**Difficulty**: Easy
**Company Frequency**: Google, Meta, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Climbing Stairs (LC 70). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Dynamic Programming paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Coin Change (LC 322)

**Difficulty**: Medium
**Company Frequency**: Google, Meta, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Coin Change (LC 322). This is a more challenging algorithmic problem."
...
## Question 3: Edit Distance (LC 72)

**Difficulty**: Hard
**Company Frequency**: Google, Meta, Microsoft
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Edit Distance (LC 72). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Dynamic Programming | Harder variations | Solve 5 more problems in this paradigm |
