...
## Question 1: Randomized Quick Sort

**Difficulty**: Medium
**Company Frequency**: Google, Meta
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Randomized Quick Sort. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Randomized Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Reservoir Sampling (LC 398)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Reservoir Sampling (LC 398). This is a more challenging algorithmic problem."
...
## Question 3: Karger Minimum Cut Algorithm

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Karger Minimum Cut Algorithm. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Randomized Algorithms | Harder variations | Solve 5 more problems in this paradigm |
