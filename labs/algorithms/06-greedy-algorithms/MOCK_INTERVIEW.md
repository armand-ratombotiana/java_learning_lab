...
## Question 1: Jump Game (LC 55)

**Difficulty**: Medium
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Jump Game (LC 55). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Greedy Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Task Scheduler (LC 621)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Task Scheduler (LC 621). This is a more challenging algorithmic problem."
...
## Question 3: Gas Station (LC 134)

**Difficulty**: Medium
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Gas Station (LC 134). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Greedy Algorithms | Harder variations | Solve 5 more problems in this paradigm |
