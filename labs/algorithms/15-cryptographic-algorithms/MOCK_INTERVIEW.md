...
## Question 1: Implement SHA-256 Hash

**Difficulty**: Hard
**Company Frequency**: Google, Microsoft
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Implement SHA-256 Hash. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Cryptographic Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: RSA Key Generation

**Difficulty**: Hard
**Company Frequency**: Amazon, Oracle
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: RSA Key Generation. This is a more challenging algorithmic problem."
...
**Interviewer**: "Final problem: Digital Signature Verification. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Cryptographic Algorithms | Harder variations | Solve 5 more problems in this paradigm |
