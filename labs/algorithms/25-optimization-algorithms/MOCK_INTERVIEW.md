...
## Question 1: Traveling Salesman with Simulated Annealing

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Traveling Salesman with Simulated Annealing. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Optimization Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Genetic Algorithm for Knapsack

**Difficulty**: Hard
**Company Frequency**: Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Genetic Algorithm for Knapsack. This is a more challenging algorithmic problem."
...
## Question 3: Particle Swarm Optimization

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Particle Swarm Optimization. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Optimization Algorithms | Harder variations | Solve 5 more problems in this paradigm |
