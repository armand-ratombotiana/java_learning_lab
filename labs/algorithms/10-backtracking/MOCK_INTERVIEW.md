...
## Question 1: Subsets (LC 78)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Subsets (LC 78). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Backtracking paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Permutations (LC 46)

**Difficulty**: Medium
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Permutations (LC 46). This is a more challenging algorithmic problem."
...
## Question 3: N-Queens (LC 51)

**Difficulty**: Hard
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: N-Queens (LC 51). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Backtracking | Harder variations | Solve 5 more problems in this paradigm |
