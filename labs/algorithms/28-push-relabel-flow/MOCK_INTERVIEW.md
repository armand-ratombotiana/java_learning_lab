...
## Question 1: Push-Relabel Algorithm

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Push-Relabel Algorithm. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Push-Relabel and Min-Cost Flow paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Min-Cost Max Flow

**Difficulty**: Hard
**Company Frequency**: Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Min-Cost Max Flow. This is a more challenging algorithmic problem."
...
## Question 3: Relabel-to-Front Optimization

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Relabel-to-Front Optimization. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Push-Relabel and Min-Cost Flow | Harder variations | Solve 5 more problems in this paradigm |
