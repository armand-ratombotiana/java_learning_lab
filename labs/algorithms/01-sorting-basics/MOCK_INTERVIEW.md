...
## Question 1: Sort Colors Dutch National Flag (LC 75)

**Difficulty**: Medium
**Company Frequency**: Google, Meta, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Sort Colors Dutch National Flag (LC 75). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Sorting Basics paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Sort an Array (LC 912)

**Difficulty**: Medium
**Company Frequency**: Amazon, Microsoft
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Sort an Array (LC 912). This is a more challenging algorithmic problem."
...
## Question 3: Insertion Sort List (LC 147)

**Difficulty**: Medium
**Company Frequency**: Microsoft
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Insertion Sort List (LC 147). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Sorting Basics | Harder variations | Solve 5 more problems in this paradigm |
