...
## Question 1: Merge k Sorted Lists (LC 23)

**Difficulty**: Hard
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Merge k Sorted Lists (LC 23). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Divide and Conquer paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Count of Smaller Numbers After Self (LC 315)

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Count of Smaller Numbers After Self (LC 315). This is a more challenging algorithmic problem."
...
## Question 3: Reverse Pairs (LC 493)

**Difficulty**: Hard
**Company Frequency**: Google, Amazon, Meta
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Reverse Pairs (LC 493). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Divide and Conquer | Harder variations | Solve 5 more problems in this paradigm |
