...
## Question 1: Online Paging Problem

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Online Paging Problem. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Online Algorithms paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Ski Rental Problem

**Difficulty**: Medium
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Ski Rental Problem. This is a more challenging algorithmic problem."
...
## Question 3: Secretary Problem Algorithm

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Secretary Problem Algorithm. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Online Algorithms | Harder variations | Solve 5 more problems in this paradigm |
