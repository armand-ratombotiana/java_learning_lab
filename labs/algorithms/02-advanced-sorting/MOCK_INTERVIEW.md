...
## Question 1: Sort List with Merge Sort (LC 148)

**Difficulty**: Medium
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Sort List with Merge Sort (LC 148). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Advanced Sorting paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Kth Largest Element (LC 215)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Kth Largest Element (LC 215). This is a more challenging algorithmic problem."
...
## Question 3: Wiggle Sort II (LC 324)

**Difficulty**: Medium
**Company Frequency**: Google, Meta
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Wiggle Sort II (LC 324). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Advanced Sorting | Harder variations | Solve 5 more problems in this paradigm |
