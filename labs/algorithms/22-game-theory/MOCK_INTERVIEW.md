...
## Question 1: Nim Game (LC 292)

**Difficulty**: Easy
**Company Frequency**: Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Nim Game (LC 292). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Game Theory paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Predict the Winner (LC 486)

**Difficulty**: Medium
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Predict the Winner (LC 486). This is a more challenging algorithmic problem."
...
## Question 3: Minimax with Alpha-Beta Pruning

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Minimax with Alpha-Beta Pruning. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Game Theory | Harder variations | Solve 5 more problems in this paradigm |
