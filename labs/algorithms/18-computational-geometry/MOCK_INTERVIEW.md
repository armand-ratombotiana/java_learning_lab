...
## Question 1: Convex Hull Graham Scan

**Difficulty**: Hard
**Company Frequency**: Google, Meta
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Convex Hull Graham Scan. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Computational Geometry paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Line Segment Intersection

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Line Segment Intersection. This is a more challenging algorithmic problem."
...
## Question 3: Closest Pair of Points

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Closest Pair of Points. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Computational Geometry | Harder variations | Solve 5 more problems in this paradigm |
