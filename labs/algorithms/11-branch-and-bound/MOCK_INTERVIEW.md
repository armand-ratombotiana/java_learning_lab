...
## Question 1: Traveling Salesman Problem

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Traveling Salesman Problem. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Branch and Bound paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: 0/1 Knapsack with Branch and Bound

**Difficulty**: Hard
**Company Frequency**: Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: 0/1 Knapsack with Branch and Bound. This is a more challenging algorithmic problem."
...
## Question 3: Job Assignment Problem

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Job Assignment Problem. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Branch and Bound | Harder variations | Solve 5 more problems in this paradigm |
