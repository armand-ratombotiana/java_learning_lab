...
## Question 1: Manacher Longest Palindrome (LC 5)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Manacher Longest Palindrome (LC 5). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the String Algorithms Advanced paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Burrows-Wheeler Transform

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Burrows-Wheeler Transform. This is a more challenging algorithmic problem."
...
## Question 3: Suffix Automaton Construction

**Difficulty**: Hard
**Company Frequency**: Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Suffix Automaton Construction. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced String Algorithms Advanced | Harder variations | Solve 5 more problems in this paradigm |
