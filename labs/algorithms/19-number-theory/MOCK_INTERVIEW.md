...
## Question 1: GCD Extended Euclidean Algorithm

**Difficulty**: Medium
**Company Frequency**: Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with GCD Extended Euclidean Algorithm. Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Number Theory paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
**Difficulty**: Medium
**Company Frequency**: Microsoft, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Sieve of Eratosthenes. This is a more challenging algorithmic problem."
...
## Question 3: Modular Exponentiation and Inverse

**Difficulty**: Hard
**Company Frequency**: Google, Amazon
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Modular Exponentiation and Inverse. This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Number Theory | Harder variations | Solve 5 more problems in this paradigm |
