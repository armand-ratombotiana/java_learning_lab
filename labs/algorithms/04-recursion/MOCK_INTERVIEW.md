...
## Question 1: Pow(x, n) (LC 50)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Let us start with Pow(x, n) (LC 50). Explain your approach and consider the trade-offs."
...
**Candidate**: "This problem fits the Recursion paradigm. The key insight is that we can leverage the specific properties of this approach to reduce the complexity. Instead of checking all possibilities, we can use a systematic method that builds up the solution incrementally."
...
## Question 2: Generate Parentheses (LC 22)

**Difficulty**: Medium
**Company Frequency**: Meta, Amazon, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Next problem: Generate Parentheses (LC 22). This is a more challenging algorithmic problem."
...
## Question 3: Letter Combinations of a Phone Number (LC 17)

**Difficulty**: Medium
**Company Frequency**: Amazon, Meta, Google
**Time Allotted**: 15 minutes

**Interviewer**: "Final problem: Letter Combinations of a Phone Number (LC 17). This is a hard algorithm problem that appears frequently in our interviews."
...
|------|-------|-----------|
| Advanced Recursion | Harder variations | Solve 5 more problems in this paradigm |
